  ...
  try {
    ...
    if (rows[0].count === 0) {
      ...
      await db.execute(`
        ...
        (2, (SELECT dog_id FROM Dogs WHERE name = 'Bella'), '2025-06-10 09:30:00', 45, 'Beachside Ave', 'accepted'),
        (3, (SELECT dog_id FROM Dogs WHERE name = 'Charlie'), '2025-07-10 01:30:00', 60, 'Milner Road', 'open'),
